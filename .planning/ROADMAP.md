...
- [x] **Phase 3: Agent API** — REST endpoints for agent control, status polling
- [x] **Phase 4: Dashboard UI** — Project list, agent status cards, job queue view
- [x] **Phase 5: Terminal Integration** — Embed ttyd terminal, split-pane layout
